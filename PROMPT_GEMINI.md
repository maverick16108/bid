...
Язык и Локализация (ВАЖНО)
	•	Весь интерфейс (меню, кнопки, сообщения, ошибки) — строго на русском языке.
	•	Никакого английского для конечного пользователя.
	•	Код (переменные, комментарии) — на английском.
	•	Общение с агентом (ответы, размышления, Task Names/Summaries) — строго на русском языке.
